...
class MobileYolo_plus:
	def __init__(self,images,labels,anchors,is_training=True,img_size=512,scope='Yolo_MobileNet_v2_plus'):
		self.images = images
		self.labels = labels
...
if __name__ == '__main__':
	...
	with tf.Session() as sess:
		mobile = MobileYolo_plus(images,labels,anchors)
